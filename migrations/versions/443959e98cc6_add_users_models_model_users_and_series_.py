...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('toy_no', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('collection_no', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    sa.Column('tampo', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('base_color_type', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('window_color', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    ...
    op.create_index(op.f('ix_models_release_year'), 'models', ['release_year'], unique=False)
